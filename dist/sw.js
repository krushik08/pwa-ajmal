...
function wrapFunction(e){return e!==IDBDatabase.prototype.transaction||"objectStoreNames"in IDBTransaction.prototype?function getCursorAdvanceMethods(){return v||(v=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}().includes(e)?function(...t){return e.apply(P(this),t),wrap_idb_value_wrap(b.get(this))}:function(...t){return wrap_idb_value_wrap(e.apply(P(this),t))}:function(t,...r){const n=e.call(P(this),t,...r)
return R.set(n,t.sort?t.sort():[t]),wrap_idb_value_wrap(n)}}function transformCachableValue(e){return"function"==typeof e?wrapFunction(e):(e instanceof IDBTransaction&&function cacheDonePromiseForTransaction(e){if(x.has(e))return
...
const S=["get","getKey","getAll","getAllKeys","count"],L=["put","add","delete","clear"],T=new Map
function getMethod(e,t){if(!(e instanceof IDBDatabase)||t in e||"string"!=typeof t)return
if(T.get(t))return T.get(t)
const r=t.replace(/FromIndex$/,""),n=t!==r,a=L.includes(r)
...
r("2KUI")
const q="workbox-expiration",I="cache-entries",M=e=>{const t=new URL(e,location.href)
...
return t&&r.addEventListener("blocked",()=>t()),wrap_idb_value_wrap(r).then(()=>void 0)}(this._cacheName)}async setTimestamp(e,t){const r={url:e=M(e),timestamp:t,cacheName:this._cacheName,id:this._getId(e)},n=await this.getDb()
...
return s}_getId(e){return this._cacheName+"|"+M(e)}async getDb(){return this._db||(this._db=await function openDB(e,t,{blocked:r,upgrade:n,blocking:a,terminated:o}={}){const s=indexedDB.open(e,t),i=wrap_idb_value_wrap(s)
return n&&s.addEventListener("upgradeneeded",e=>{n(wrap_idb_value_wrap(s.result),e.oldVersion,e.newVersion,wrap_idb_value_wrap(s.transaction))}),r&&s.addEventListener("blocked",()=>r()),i.then(e=>{o&&e.addEventListener("close",()=>o()),a&&e.addEventListener("versionchange",()=>a())}).catch(()=>{}),i}(q,1,{upgrade:this._upgradeDbAndDeleteOldDbs.bind(this)})),this._db}}class CacheExpiration_CacheExpiration{constructor(e,t={}){this._isRunning=!1,this._rerunRequested=!1,this._maxEntries=t.maxEntries,this._maxAgeSeconds=t.maxAgeSeconds,this._matchOptions=t.matchOptions,this._cacheName=e,this._timestampModel=new CacheTimestampsModel_CacheTimestampsModel(e)}async expireEntries(){if(this._isRunning)return void(this._rerunRequested=!0)
this._isRunning=!0
...
return r}}const W={cacheWillUpdate:async({response:e})=>200===e.status||0===e.status?e:null}
class NetworkFirst_NetworkFirst extends Strategy_Strategy{constructor(e={}){super(e),this.plugins.some(e=>"cacheWillUpdate"in e)||this.plugins.unshift(W),this._networkTimeoutSeconds=e.networkTimeoutSeconds||0}async _handle(e,t){const r=[]
const n=[]
let a
...
return a}}var A=r("cDf5"),N=r.n(A),U=r("yXPU"),D=r.n(U)
r("jLCR")
...
var e={},t=Object.prototype,r=t.hasOwnProperty,n=Object.defineProperty||function(e,t,r){e[t]=r.value},a="function"==typeof Symbol?Symbol:{},o=a.iterator||"@@iterator",s=a.asyncIterator||"@@asyncIterator",i=a.toStringTag||"@@toStringTag"
function define(e,t,r){return Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}),e[t]}try{define({},"")}catch(e){define=function define(e,t,r){return e[t]=r}}function wrap(e,t,r,a){var o=t&&t.prototype instanceof Generator?t:Generator,s=Object.create(o.prototype),i=new Context(a||[])
return n(s,"_invoke",{value:makeInvokeMethod(e,r,i)}),s}function tryCatch(e,t,r){try{return{type:"normal",arg:e.call(t,r)}}catch(e){return{type:"throw",arg:e}}}e.wrap=wrap
var c={}
...
n(this,"_invoke",{value:function value(n,o){function callInvokeWithMethodAndArg(){return new t(function(a,s){!function invoke(n,a,o,s){var i=tryCatch(e[n],e,a)
if("throw"!==i.type){var c=i.arg,u=c.value
return u&&"object"==N()(u)&&r.call(u,"__await")?t.resolve(u.__await).then(function(e){invoke("next",e,o,s)},function(e){invoke("throw",e,o,s)}):t.resolve(u).then(function(e){c.value=e,o(c)},function(e){return invoke("throw",e,o,s)})}s(i.arg)}(n,o,a,s)})}return a=a?a.then(callInvokeWithMethodAndArg,callInvokeWithMethodAndArg):callInvokeWithMethodAndArg()}})}function makeInvokeMethod(e,t,r){var n="suspendedStart"
...
return e.isGeneratorFunction(r)?s:s.next().then(function(e){return e.done?e.value:s.next()})},defineIteratorMethods(f),define(f,i,"Generator"),define(f,o,function(){return this}),define(f,"toString",function(){return"[object Generator]"}),e.keys=function(e){var t=Object(e),r=[]
...
return s.type=e,s.arg=t,o?(this.method="next",this.next=o.finallyLoc,c):this.complete(s)},complete:function complete(e,t){if("throw"===e.type)throw e.arg
...
return function isImage(e){return j.test(e.pathname)}(t)&&!isNaN(K(t))},G=function(){var e=D()(_regeneratorRuntime().mark(function _callee(e){var t,r,n,a,o,s,i,c,u,l,h,f
return _regeneratorRuntime().wrap(function _callee$(d){for(;;)switch(d.prev=d.next){case 0:return t=K(e),r=e.pathname.split("/").reverse()[0],d.next=4,caches.open("images")
...
break}if(u=c.value,l=K(new URL(u.url)),!isNaN(l)){d.next=20
...
importScripts("https://storage.googleapis.com/workbox-cdn/releases/6.2.4/workbox-sw.js"),function skipWaiting(){self.skipWaiting()}(),function clientsClaim(){self.addEventListener("activate",()=>self.clients.claim())}(),precacheAndRoute([{'revision':null,'url':'/1.2921f3540c54c81964bb.js'},{'revision':null,'url':'/18.6986ad38df94b7b7ceac.js'},{'revision':null,'url':'/19.c09375c42bf8a191d725.js'},{'revision':null,'url':'/2.7586571f1f8adb7e5008.js'},{'revision':null,'url':'/20.96c75fb4897fbf78b0ce.js'},{'revision':null,'url':'/21.0135430ff69a8ea57e0a.js'},{'revision':null,'url':'/22.13725be17c3de4ae4871.js'},{'revision':null,'url':'/23.81284359dce124676504.js'},{'rev
8','url':'/IconPlus-qGq.svg'},{'revision':'1198ee09e3b126361ef2847b279afed9','url':'/IconPlusGold-sVi.svg'},{'revision':'ec94ad49a76e7f67d50e358005c2893c','url':'/IconProductLike-8tz.svg'},{'revision':'92c5e017030dce295d1cba1740af8996','url':'/IconShare-jAa.svg'},{'revision':'d1f968c25c19105887605a9fb9d2b61f','url':'/IconStarBlank-4V9.svg'},{'revision':'860f859b73c3c4e873faac2c95fa9c6a','url':'/IconStarGold-eaz.svg'},{'revision':'ec941030f4aec32779091b4f72000b7e','url':'/IconStarLightGold-gyJ.svg'},{'revision':'14f75670fe81190651d12db3b99a2061','url':'/IconStarSmall-cZC.svg'},{'revision':'0f111fb684615dad932312d0255730c7','url':'/IconTruck-qAB.svg'},{'revision':'027fc15953c1937da50e184309f64b40','url':'/ProductBg-8Wu.svg'},{'revision':null,'url':'/RootCmp_CATEGORY__default.24620756c2db1aae33a4.js'},{'revision':null,'url':'/RootCmp_CMS_PAGE__default.57cdb91bbf7396f12376.js'},{'revision':null,'url':'/RootCmp_PRODUCT__default.540f93ab0a593ecd260d.js'},{'revision':'483658ae09a6fe6e20a5f6ed80dd8f0f','url':'/SpotiiLogo-2Vs.svg'},{'revision':null,'url':'/client.714d21e579f7a0a56477.js'},{'revision':null,'url':'/i18n-en_AR.79d14a01fa45f523bc0b.js'},{'revision':null,'url':'/i18n-en_US.44b7a4c9c54db7d8f189.js'},{'revision':'759699e45e0af8a8eaf706ca2aa00f9a','url':'/next-arrow-k2p.svg'},{'revision':'819c367881ffec0d0c6c0f4a08e9c549','url':'/oud-img-a7n.svg'},{'revision':'ede4a7e581d1c44212661381c57878dd','url':'/rose-img-tmc.svg'},{'revision':null,'url':'/runtime.6c43f3e5a5abba5c5d05.js'},{'revision':'d42ef9b2f70f0a0460b66d4aeca074bb','url':'/vanilla-img-p9z.svg'},{'revision':null,'url':'/vendors.2533ff9b4458fa76a82b.js'},{'revision':null,'url':'/vendors~RootCmp_CATEGORY__default~RootCmp_CMS_PAGE__default~RootCmp_PRODUCT__default.182359adf45d655b1b12.js'},{'revision':null,'url':'/vendors~RootCmp_PRODUCT__default.01feb6666658d54c7786.js'},{'revision':null,'url':'/vendors~RootCmp_SEARCH__default.01b235018a21959d89e8.js'}]||[]),F=function createImageCacheHandler(){return new CacheFirst_CacheFirst({cacheName:"images",plugins:[new ExpirationPlugin_ExpirationPlugin({maxEntries:60,maxAgeSeconds:2592e3,matchOptions:{ignoreVary:!0}}),new CacheableResponsePlugin_CacheableResponsePlugin({statuses:[0,200]})]})}(),registerRoute(new RegExp("(robots.txt|favicon.ico|manifest.json)"),new StaleWhileRevalidate_StaleWhileRevalidate),registerRoute(B,function(e){var t=e.url,r=e.request,n=e.event,a=G(t,r)
